    ...
    <?php echo form_open('account/signup',array("id"=>"signupForm", "role"=>"form",)); ?>
      <fieldset>
        ...
        <div>
          ...
          <div class="form-group">
           <div class="col-md-6"><input type="text" name='first_name' id="first_name" value="<?php echo $this->input->post('first_name');?>" class='form-control' placeholder='Name' title='First Name' required autofocus /></div>
          </div>
          <div class="form-group">
            <div class="col-md-6">
          ...
          <div class="form-group">
            <div class="col-md-12"><input type="text" name='address' id='address' value="<?php echo $this->input->post('address');?>" class='form-control' placeholder='Address' title='Address'/></div>
              ...
              <input type="hidden" name="position" value="admin" class='form-control' title='Position'>
          <div class="form-group">
      ...
      <fieldset>
        ...
        <div style="display: none;">
          <div class="form-group">
            <div class="col-md-12"><textarea name="memo" id="memo" class="form-control" rows="5"><?php echo $this->input->post('memo');?></textarea>
          </div>
        </div>
      </fieldset>
      <div class="form-group">
