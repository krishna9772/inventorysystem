...
{
  echo "<div class='table-responsive'><table class='table table-bordered table-striped' id='user_data'><thead><tr>
           <th>Username</th>
           <th>Name</th>
           <th>Position</th>
           <th>Email</th>
...
if($this->bitauth->is_admin())
{
  echo '<div class="btn btn-info">'.anchor('account/signup', 'Add User',array('class'=>'hidden-print')).'</div>';
}

?>
<script type="text/javascript">

    var userdata = $('#user_data').DataTable({
      "processing":true,
      "serverSide":false,
      "order":[],
      "columnDefs":[
